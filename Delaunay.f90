...
! MT(I), I=1,NE : ARRAY TO FLAG DELETED ELEMENTS, MT(I)=1:DELETE,
! MT(I)=0:KEEP
SUBROUTINE INSERT (IN,NE,ME,MF,MT,X,Y,Z)
...
Program Main 
    ...
    Logical :: MT
    DO IN=1,NN
    CALL INSERT (IN,NE,ME,MF,MT,X,Y,Z)
    IF (NE+100.GT.NEM) CALL COMPRESS (NE,ME,MF,MT)
    ENDDO
